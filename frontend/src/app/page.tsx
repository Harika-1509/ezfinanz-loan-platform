        ...
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link href="/signup">
              <Button
                size="lg"
                className="bg-emerald-500 hover:bg-emerald-600 text-slate-950 font-black shadow-glow text-sm px-6 h-12 focus-visible:ring-2 focus-visible:ring-emerald-400"
              >
                Apply for Loan
            ...
            <Link href="/login">
              <Button
                size="lg"
                variant="outline"
                className="border-slate-700 bg-slate-800/80 text-white hover:bg-slate-700 text-sm px-6 h-12 font-bold"
              >
          ...
          {/* Trust Highlights */}
          <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-4 max-w-4xl mx-auto pt-8 border-t border-slate-800 text-left">
            <div className="flex items-start space-x-3">
              <div className="rounded-lg bg-emerald-950/80 p-2 border border-emerald-500/20 text-emerald-400 shrink-0">
            ...
            <div className="flex items-start space-x-3">
              <div className="rounded-lg bg-teal-950/80 p-2 border border-teal-500/20 text-teal-400 shrink-0">
            ...
            <div className="flex items-start space-x-3">
              <div className="rounded-lg bg-indigo-950/80 p-2 border border-indigo-500/20 text-indigo-400 shrink-0">
            ...
            <div className="flex items-start space-x-3">
              <div className="rounded-lg bg-cyan-950/80 p-2 border border-cyan-500/20 text-cyan-400 shrink-0">
        ...
        <div className="mb-4 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              className="rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-xs font-bold text-slate-800 shadow-xs focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200"
            >
              {DEMO_STAGES.map((s) => (
        ...
        <div className="mt-4 flex flex-wrap gap-2 pt-2">
          {DEMO_STAGES.map((s) => (
            <button
              ...
              className={`rounded-lg px-2.5 py-1 text-xs font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="border-slate-200/80 shadow-glass">
            ...
            <CardContent className="space-y-3">
              ...
              <Button
                variant="outline"
                className="w-full justify-start text-xs font-bold text-slate-600 dark:text-slate-400"
          ...
          <Card className="border-slate-200/80 shadow-glass">
            ...
            <CardContent className="space-y-2 text-xs">
              <div className="flex justify-between py-1 border-b border-slate-100 dark:border-slate-800">
                ...
                <span className="font-bold">
                  {isAuthenticated ? (
                    ...
                    <Badge variant="secondary" className="font-bold">Guest / Unauthenticated</Badge>
                  )}
                </span>
              </div>

              <div className="flex justify-between py-1 border-b border-slate-100 dark:border-slate-800">
                <span className="text-slate-600 dark:text-slate-400">Active Role:</span>
              ...
              <div className="flex justify-between py-1">
                <span className="text-slate-600 dark:text-slate-400">Application Stage:</span>
          ...
          <Card className="border-slate-200/80 shadow-glass">
            <CardHeader>
              ...
              <CardDescription className="text-xs text-slate-600 dark:text-slate-400">
                Full client security & tokens architecture.
              </CardDescription>
            </CardHeader>
