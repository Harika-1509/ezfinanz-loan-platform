  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (err instanceof ApiError) {
        ...
        setError('Failed to submit selfie photo. Please try again.');
      }
    } finally {
      ...
      <Card className="border-emerald-200/80 bg-gradient-to-b from-white via-slate-50/50 to-emerald-50/30 shadow-glass dark:border-emerald-900/40 dark:from-slate-900 dark:via-slate-900 dark:to-emerald-950/30">
        <CardContent className="flex flex-col items-center justify-center p-8 sm:p-12 text-center space-y-6">
          ...
          <div className="space-y-2 max-w-lg">
            <Badge variant="outline" className="text-emerald-700 bg-emerald-50 dark:bg-emerald-950/50 text-xs px-3 py-1 font-bold">
          ...
          {/* Details Card */}
          <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white/80 p-5 text-xs text-left shadow-xs dark:border-slate-800 dark:bg-slate-850 space-y-3">
            ...
            <div className="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-slate-800">
              ...
              <span className="inline-flex items-center font-bold text-amber-600 dark:text-amber-400">
      ...
      <div className="lg:col-span-7 space-y-6">
        <Card className="border-slate-200/80 shadow-glass dark:border-slate-800">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="relative mx-auto flex aspect-square max-w-[360px] sm:max-w-[400px] items-center justify-center overflow-hidden rounded-3xl border-2 border-slate-800 bg-slate-950 shadow-inner">
              ...
              {capturedImage ? (
                ...
                <>
                  ...
                  <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                    <div className="h-64 w-48 rounded-[50%] border-2 border-dashed border-emerald-400/80 shadow-glow" />
                  </div>

                  <div className="pointer-events-none absolute bottom-3 left-0 right-0 text-center">
                    <span className="rounded-full bg-black/60 px-3 py-1 text-[10px] font-bold text-emerald-300 backdrop-blur-md">
      ...
      <div className="lg:col-span-5 space-y-6">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-glass dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="mt-4 space-y-3 text-xs">
            <div className="flex items-start space-x-2.5 rounded-xl bg-slate-50 p-3 dark:bg-slate-850">
          ...
          <div className="mt-6 rounded-2xl border border-emerald-200/70 bg-emerald-50/50 p-4 text-[11px] text-emerald-800 dark:border-emerald-900/50 dark:bg-emerald-950/20 dark:text-emerald-300">
